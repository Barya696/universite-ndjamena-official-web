  ...
  return (
    <div style={{ background: PARCHMENT }} className="min-h-screen">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <SectionHeading roman="II." title="Calendrier 2024–2025" />
              ...
              <div className="bg-white" style={{ boxShadow: SHADOW, border: `1px solid ${LINE}` }}>
                {mois.list.map((ev, i) => (
                  ...
                  >
                    ...
                    <div>
                      <p className="text-[10px] uppercase tracking-widest mb-1" style={{ color: INK_SOFT, fontFamily: FONT }}>Événement</p>
