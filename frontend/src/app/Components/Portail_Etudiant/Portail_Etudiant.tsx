...
/* ─────────────────────────────────────────────────────────────────────────
   DESIGN SYSTEM — one continuous administrative page.
...
function SectionHeading({
  ...
  return (
    <div id={id} style={{ display: "flex", alignItems: "center", gap: 12, scrollMarginTop: 76 } as React.CSSProperties}>
...
/* ── Masthead ── */
function Masthead({ onLogout }: { onLogout: () => void }) {
  const links = [
    ...
    <div style={{ minHeight: "100vh", background: BG, fontFamily: SANS }}>
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .so-masthead-nav a:hover { background: rgba(255,255,255,0.06); color: #fff; }
      ...
      <Masthead onLogout={onLogout} />

      <main>
        {/* ── Vue d'ensemble ── */}
        <section>
          <SectionHeading id="vue-ensemble" icon={Home} title="Vue d'ensemble" subtitle={`${STUDENT.year} · ${STUDENT.semester} · ${STUDENT.level}`} />
        ...
        {/* ── Cours & résultats ── */}
        <section>
          <SectionHeading id="cours-resultats" icon={FileText} title="Cours & résultats" subtitle="Relevé provisoire — inscription, notes et statut par unité d'enseignement" />
        ...
        {/* ── Emploi du temps ── */}
        <section>
          <SectionHeading id="emploi-du-temps" icon={Calendar} title="Emploi du temps" subtitle="Semaine du 9 au 15 septembre 2024" />
        ...
        <section>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 12 }}>
            <SectionHeading id="paiements" icon={CreditCard} title="Paiements" subtitle={`Année académique ${STUDENT.year}`} />
        ...
        {/* ── Profil ── */}
        <section>
          <SectionHeading id="profil" icon={User} title="Profil" subtitle="Coordonnées et identifiants de connexion" />
